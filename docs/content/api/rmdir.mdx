...
- **Unsupported Node inputs/options**: `Buffer` paths, `URL` paths, and legacy `rmdir` options such as deprecated recursive removal are not part of the current Rush-FS `rmdir` surface.
